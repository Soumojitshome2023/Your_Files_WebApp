...
document.getElementById("input_file_option").addEventListener("change", () => {
  ...
  if (document.getElementById("user_email_inputField").value.trim() == "") {
    document.getElementById("upload_status").innerHTML = `<i class="fa-solid fa-triangle-exclamation"></i> Please Sign In or Sign Up`;
  }
  else {
...
function upload_file() {
  ...
  let folder_name = sessionStorage.getItem("useruid");
  let input_file_option = document.getElementById("input_file_option").value;

  if (folder_name != null && input_file_option != "") {
...
function get_file() {
  ...
  let code = sessionStorage.getItem("useruid");
  ...
  if (code != null) {
    ...
    document.getElementById("your_files_heading").innerHTML = `<div><i class="fa-solid fa-triangle-exclamation"></i>Please Sign In or Sign Up</div>`
